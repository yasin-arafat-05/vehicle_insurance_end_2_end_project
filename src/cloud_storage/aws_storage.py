...
class SimpleStorageService:
    """
    Description: A class for interacting with AWS S3 storage, providing methods for file management, 
    data uploads, and data retrieval in S3 buckets.
    """

    def __init__(self):
        """
        Description: Initializes the SimpleStorageService instance with S3 resource and client
    ...
    def s3_key_path_available(self, bucket_name, s3_key) -> bool:
        """
        Description: Checks if a specified S3 key path (file path) is available in the specified bucket.
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        """
        Description: Reads the specified S3 object with optional decoding and formatting.
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        """
        Description: Retrieves the S3 bucket object based on the provided bucket name.
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        """
        Description: Retrieves the file object(s) from the specified bucket based on the filename.
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
        """
        Description: Loads a serialized model from the specified S3 bucket.
    ...
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        """
        Description: Uploads a local file to the specified S3 bucket with an optional file deletion.
    ...
    def upload_df_as_csv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
        """
        Description: Uploads a DataFrame as a CSV file to the specified S3 bucket.
    ...
    def get_df_from_object(self, object_: object) -> DataFrame:
        """
        Description: Converts an S3 object to a DataFrame.
        Args:
    ...
    def read_csv(self, filename: str, bucket_name: str) -> DataFrame:
        """
        Description: Reads a CSV file from the specified S3 bucket and converts it to a DataFrame.
