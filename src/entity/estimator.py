...
class MyModel:
    def __init__(self, preprocessing_object: Pipeline, trained_model_object: object):
        """
        Description: MyModel Constructor
        
        Args:
            preprocessing_object (pipeline): Input Object of preprocesser
    ...
    def predict(self, dataframe: pd.DataFrame) -> DataFrame:
        """
        Description: Function accepts preprocessed inputs (with all custom transformations already applied),
