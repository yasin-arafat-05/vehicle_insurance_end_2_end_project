...
app = FastAPI(description="Vehicle insurance project")
...
class DataForm:
    """
    Description: DataForm class to handle and process incoming form data.
...
async def index(request: Request):
    """
    Description: Renders the main HTML form page for vehicle data input.
    """
...
if __name__ == "__main__":
    app_run(app, host=CONFIG.APP_HOST, port=CONFIG.APP_PORT)